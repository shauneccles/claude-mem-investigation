...
Then I pulled the full stargazer stream — all 66,433 of them with `starredAt` and account metadata, via GraphQL. The baseline before the repo got known (pre-December 2025) was 3.3% throwaway-shaped accounts (0 repos, 0 followers) and 0% accounts less than a day old when they starred. That's what organic stars from a dev audience look like. The **April 13 calendar week, the single biggest week in the repo's life at 13,546 stars**, runs at **13.1% throwaway, 5.1% accounts under 30 days old, 1.2% under 1 day, 0.78% under 1 hour**. The throwaway rate rises materially over the last three months — from a 3% baseline to 13% in the peak week.
